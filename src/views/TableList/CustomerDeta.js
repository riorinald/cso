...
class CustomerData extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  queryString() {
    ...
    let queryString = `${config.apiCust}?$limit=${pageSize}&$skip=${pageSize * currentPage}`;
...
export default withStyles(styles, { withTheme: true })(CustomerData);
